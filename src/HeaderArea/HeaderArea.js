...
import {MdSearch, MdVideoCall,MdMic, MdViewComfy, MdFilter1, MdMovieFilter} from 'react-icons/md'
                ...
                <div className="Header">
                     ...
                     <div className="Icon">
                       ...
                       <FaYoutube color="red" fontSize="3rem"/> &nbsp;
                        ...
                        <div className="icon"> <MdFilter1 fontSize="2.8rem"/></div>
                        <div className="icon"> <MdMovieFilter fontSize="2.8rem"/></div>                        
